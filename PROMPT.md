We're building "Bench" - an AI-powered fractional talent connector. Think Boardy.ai but for fractional executive recruiting (CFO, CMO, COO, CTO, etc.).
...
Brand: Bench | AI Persona: Scout | Tagline: "Top talent, fractionally yours"
...
openclaw system event --text "Bench MVP scaffold complete - Next.js + Supabase schema done" --mode now
